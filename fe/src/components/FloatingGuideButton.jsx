...
const FloatingGuideButton = () => {
  ...
  const closeModal = () => setShowGuide(false);

  return (
    <>
      <button
        onClick={() => setShowGuide(!showGuide)}
        className="fixed top-14 right-20 z-40 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors flex items-end justify-end"
